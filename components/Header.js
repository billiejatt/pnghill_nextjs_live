...
const Header = () => {
    ...
    const modalVariants = {
        ...
        exit: { opacity: 0, scale: 0.8, transition: { type: "spring", duration: 0.5 } }
    };
            ...
            <AnimatePresence>
                {isModalOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 h-screen flex items-center justify-center bg-slate-200 bg-opacity-50 z-40"
                        onClick={closeModal}
                    >
                        <motion.div
